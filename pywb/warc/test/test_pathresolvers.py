...
# http path
>>> res.make_best_resolver('http://myhost.example.com/warcs/')
...
# redis path
>>> res.make_best_resolver('redis://myhost.example.com:1234/1')
RedisResolver('redis://myhost.example.com:1234/1')

# a file
>>> r = res.make_best_resolver(to_file_url(os.path.realpath(__file__)))
>>> r.__class__.__name__
'PathIndexResolver'

# a dir
>>> path = os.path.realpath(__file__)
>>> r = res.make_best_resolver(to_file_url(os.path.dirname(path)))
>>> r.__class__.__name__
'PrefixResolver'


# PathResolverMapper for list
>>> r = res(['http://example.com/warcs/', 'redis://example.com:1234/1'])
