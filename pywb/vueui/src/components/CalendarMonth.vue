...
export default {
  ...
  computed: {
    ...
    days() {
      ...
      const daysBeforeFirst = (new Date(this.year.id, this.month.id-1, firstDay)).getDay() - PywbI18N.firstDayOfWeek;
      const daysAfterLastDay = 6 - (new Date(this.year.id, this.month.id-1, lastDay)).getDay() + PywbI18N.firstDayOfWeek;
