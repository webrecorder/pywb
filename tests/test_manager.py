...
class TestManager:
    ...
    def test_add_invalid_wacz(self, tmp_path, caplog):
    ...
    def test_add_valid_archives(self, tmp_path):
        manager = self.get_test_collections_manager(tmp_path)
    ...
    def test_add_invalid_archives(self, tmp_path, caplog):
        manager = self.get_test_collections_manager(tmp_path)
